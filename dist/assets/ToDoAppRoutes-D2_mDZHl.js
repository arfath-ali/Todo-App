 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ki="FirebaseError";class Q extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=ki,Object.setPrototypeOf(this,Q.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Te.prototype.create)}}class Te{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},r=`${this.service}/${e}`,i=this.errors[e],a=i?Ti(i,s):"Error",c=`${this.serviceName}: ${a} (${r}).`;return new Q(r,c,s)}}function Ti(t,e){return t.replace(Ci,(n,s)=>{const r=e[s];return r!=null?String(r):`<${s}?>`})}const Ci=/\{\$([^}]+)}/g;function Ni(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function _e(t,e){if(t===e)return!0;const n=Object.keys(t),s=Object.keys(e);for(const r of n){if(!s.includes(r))return!1;const i=t[r],a=e[r];if(Ln(i)&&Ln(a)){if(!_e(i,a))return!1}else if(i!==a)return!1}for(const r of s)if(!n.includes(r))return!1;return!0}function Ln(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sr="installations",Co="installations-internal",No=t=>{const e=t.getProvider("app").getImmediate(),n=To(e),s=Me(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},Ao=t=>{const e=t.getProvider("app").getImmediate(),n=Me(e,sr).getImmediate();return{getId:()=>So(n),getToken:r=>Eo(n,r)}};function Po(){ie(new X(sr,No,"PUBLIC")),ie(new X(Co,Ao,"PRIVATE"))}Po();J(Bs,fn);J(Bs,fn,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xc(t,e){return Ue(t,"POST","/v1/accounts:delete",e)}async function kt(t,e){return Ue(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jc(t,e,n=!1){const{auth:s}=t;if(K(s.app))return Promise.reject(Ie(s));const r="reauthenticate";try{const i=await et(t,kr(s,r,e,t),n);y(i.idToken,s,"internal-error");const a=xn(i.idToken);y(a,s,"internal-error");const{sub:c}=a;return y(t.uid===c,s,"user-mismatch"),je._forOperation(t,r,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Z(s,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
